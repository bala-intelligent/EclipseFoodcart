...
legend {
  ...
  body {
    background: url("<c:url value="/resources/image/welcome.jpg"/>") no-repeat;
...
<div class="container">
			<fieldset>
				...
				<br /><br />
				<p class="text danger"><!-- display the userId just entered -->
				Welcome ${registration.username}</p>
				<br/>
			</fieldset>
		</div>
</body>
